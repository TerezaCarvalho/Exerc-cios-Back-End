...
db.movies.updateOne({ title:"Batman"}, {$push: {category: {$each: ["villain", "comic_based"]}}});
...
db.movies.updateOne({title: {$in: ["Batman", "Home Alone"]}}, { $push: { "category": "90's" }} );

// Exercício 8: Crie um array de documentos chamado cast para
// o filme Home Alone com os seguintes dados:
...
// Exercício 9: Adicione o campo character com o valor Marv ao array de cast em que o campo 
// actor seja igual a Daniel Stern no filme Home Alone.
db.movies.updateOne({title: "Home Alone", "cast.actor": "Daniel Stern"}, {$set: { "cast.$.character": "Marv"}});
// usei $push mas adicionou um array;

// Exercício 10: Crie um array de documentos chamado cast para o filme Batman com os seguintes dados:
db.movies.updateOne({ 
  title: "Batman"}, {$push: {cast: {$each: [
    {
      "character": "Batman"
    },
    {
...
// Adicione o campo actor que deve ser um array com o valor "Michael Caine" ao array de
// cast em que o campo character seja igual a Alfred;
